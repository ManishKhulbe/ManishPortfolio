...
export default function Experience() {
  ...
  return (
    <>
      <Head>
        <title>Experience | Manish Khulbe </title>
        <meta name="description" content="My experience as a web developer." />
        <meta property="og:title" content="Experience | Manish Khulbe" />
        <meta
      ...
      <Section>
        ...
        <Description>
          ...
          and robust backend architectures, seeking I always improve my skills
          and learn new technologies. I am always open to new challenges and
